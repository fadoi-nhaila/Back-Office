...
class Chiffres extends Model
{
	...
	function __construct($nb, $unit){
		...
		if (chiffres::DEBUG) echo "construct : [" . $this->nb . "]";
	}
	...
	private function getThree($group, $unit, $language, $gender){
		...
		if (chiffres::DEBUG) echo "<br>local a [" . $return . "] ";
		// Exceptions.
		...
		if (chiffres::DEBUG) echo "<br>local b $unit [" . $return . "] ";
		// Exceptions de genre.
		...
		if (chiffres::DEBUG) echo "<br>local c [" . $return . "] ";
		return $return;
	}
	...
	private function part($nb, $language, $gender){
		...
		if (chiffres::DEBUG) echo "<br>part a : [" . $return . "]";
		// Exceptions.
		...
		if (chiffres::DEBUG) echo "<br>part b : [" . $return . "]";
		return $return;
	}
